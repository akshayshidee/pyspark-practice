# Query all columns for a city in CITY with the ID 14.

import pyspark
from pyspark.sql import SparkSession


spark=SparkSession.builder.appName('hackerrank03.com').master("local[*]").getOrCreate()
# Set Spark log level
...
city_df.filter(city_df["ID"]==14).show()