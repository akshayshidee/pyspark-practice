...
spark=SparkSession.builder.appName('hackerrank10.com').master("local[*]").getOrCreate()
# Set Spark log level
spark.sparkContext.setLogLevel("ERROR")

station_data = [
    (1, "New York", "NY", 40.7128, -74.0060),
    (2, "Angeles", "CA", 34.0522, -118.2437),
    ...
    (8, "iami", "FL", 25.7617, -80.1918),
    (9, "Angeles", "CA", 34.0522, -118.2437),
]
...
###################>>>>>>>>>><<<<<<<<<<<< solution
#CITY names starting with vowels (a, e, i, o, u) and it is case insensitive search
