...
spark=SparkSession.builder.appName('hackerrank13.com').master("local[*]").getOrCreate()
# Set Spark log level
...
###################>>>>>>>>>><<<<<<<<<<<< solution
#select CITY names starting with vowels (a, e, i, o, u) and it is case insensitive search.
